...
Usage:
    python port-scanner.py <target> [timeout]

Examples:
    python port-scanner.py 192.168.1.1
    python port-scanner.py scanme.nmap.org 0.5
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python port-scanner.py <target> [timeout]")
        print()
        print("Examples:")
        print("  python port-scanner.py 192.168.1.1")
        print("  python port-scanner.py scanme.nmap.org 0.5")
        sys.exit(1)
